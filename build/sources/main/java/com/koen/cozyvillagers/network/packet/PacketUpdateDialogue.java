...
public class PacketUpdateDialogue implements IMessage {
    ...
    public PacketUpdateDialogue() {}

    public PacketUpdateDialogue(String villagerId, String villagerName, String profession,
    ...
    public static class Handler implements IMessageHandler<PacketUpdateDialogue, IMessage> {
        @Override
        public IMessage onMessage(PacketUpdateDialogue message, MessageContext ctx) {
            Minecraft.getMinecraft().addScheduledTask(() -> {
                GuiDialogue.applyUpdate(
                        message.villagerId,
